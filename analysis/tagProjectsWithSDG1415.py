...
# Regex patterns: non-capturing groups only (?: ... ) + word boundaries
EXTRA = {
    "SDG14.5": [
...
def main():
    ...
    # Build long table of labels (multi-label allowed)
    ...
    # Aggregate safely (separate sum + count), and use observed=True
